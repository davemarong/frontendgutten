        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Typography align="center" className={classesTypography.p}>
              Self thought and on my journey towards a professional web
              developer. I have been coding seriously for about 1 year, and I
              have no plans to stop in the future. This blog was created with
              the intent of sharing, teaching and inspiring other like minded
              people. My main focus in the front is React.js, with Strapi calmly
